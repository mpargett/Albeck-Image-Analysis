...
ip.fname = ['L:\imageData\ProcessingValidation\',...
    '2014-05-12-FRA1 C.9.nd2'];    
%   Target save name for processed data files (include path)
ip.sname = 'celltracer_v2_test_basic_nd2';  
